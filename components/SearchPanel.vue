<template>
        ...
        <div class="container-lg">
          <div class="mt-4 pt-4 w-50 text-white">
            ...
            <div class="row d-flex h3 mt-lg-5 mt-sm-2 pt-md-5 pt-sm-3 ms-1">
                  ...
                  <select class="form-select" id="select_city" name="location">
                        <option v-for="(city, index) in cityList" :key="index" :selected= "city=='Rajkot'">{{city}}</option>
                  </select>
  ...
  cityList = await rD.removeDuplicates(duplicatedCityList);
  console.log(cityList)
  
  function filterByCity(dataSet, city){
    let filteredData=[];
